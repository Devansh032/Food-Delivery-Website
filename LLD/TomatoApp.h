...
public :
    ...
    void initializeRestaurants(){
        ...
        Restaurant* restaurant2 = new Restaurant("Haldiram", "Kolkatta");
        restaurant2->addMenuItem(MenuItem("P2","Pav Bhaji",100));
        restaurant2->addMenuItem(MenuItem("P1","Raj Kachori",80));
        restaurant2->addMenuItem(MenuItem("P3","Dhokla",53));
        

        Restaurant* restaurant3 = new Restaurant("Saravana Bhavan", "Chennai");
        restaurant3->addMenuItem(MenuItem("P1","Masala Dhosa",120));
        restaurant3->addMenuItem(MenuItem("P2","Idli",15));

        RestaurantManager* restaurnantManager = RestaurantManager :: getInstance();
        restaurnantManager->addRestaurant(restaurant1);
        restaurnantManager->addRestaurant(restaurant1);
        restaurnantManager->addRestaurant(restaurant1);
